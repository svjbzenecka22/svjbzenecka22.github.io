...
## Riziko: jednotky neodpoví online

Popis: První agenda počítá s online formulářem jako jedinou standardní cestou. Pokud některá partaj formulář nevyplní, bude ve finálním souhrnu chybět odpověď za jednotku.

Mitigace: Formulář musí být co nejjednodušší a uživatelsky srozumitelný. Výbor má 2026-05-19 poslat avízo jednotkám bez odpovědi a 2026-05-24 provést finální kontrolu úplnosti. Jednotky bez odpovědi nebo se zjevnou nesrovnalostí výbor individuálně kontaktuje.
